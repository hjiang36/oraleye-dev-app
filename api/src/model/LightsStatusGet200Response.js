...
class LightsStatusGet200Response {
  ...
  static validateJSON(data) {
    ...
    if (
      data['white_led'] &&
      !(
        typeof data['white_led'] === 'string' ||
        data['white_led'] instanceof String
      )
    ) {
      throw new Error(
        'Expected the field `white_led` to be a primitive type in the JSON string but got ' +
          data['white_led']
      );
    }
    // ensure the json data is a string
    if (
      data['blue_led'] &&
      !(
        typeof data['blue_led'] === 'string' ||
        data['blue_led'] instanceof String
      )
    ) {
      throw new Error(
        'Expected the field `blue_led` to be a primitive type in the JSON string but got ' +
          data['blue_led']
      );
    }
    // ensure the json data is a string
    if (
      data['red_laser'] &&
      !(
        typeof data['red_laser'] === 'string' ||
        data['red_laser'] instanceof String
      )
    ) {
      throw new Error(
        'Expected the field `red_laser` to be a primitive type in the JSON string but got ' +
          data['red_laser']
      );
    }
