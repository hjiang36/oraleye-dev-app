...
export default class LightsApi {
  ...
  lightsBlueMaxTimePost(lightsBlueMaxTimePostRequest, callback) {
    ...
    if (
      lightsBlueMaxTimePostRequest === undefined ||
      lightsBlueMaxTimePostRequest === null
    ) {
      throw new Error(
        "Missing the required parameter 'lightsBlueMaxTimePostRequest' when calling lightsBlueMaxTimePost"
      );
    }
  ...
  lightsControlPost(lightsStatusGet200Response, callback) {
    ...
    if (
      lightsStatusGet200Response === undefined ||
      lightsStatusGet200Response === null
    ) {
      throw new Error(
        "Missing the required parameter 'lightsStatusGet200Response' when calling lightsControlPost"
      );
    }
